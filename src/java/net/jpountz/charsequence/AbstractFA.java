 ...
 * An automaton.
 */
abstract class AbstractFA<State> extends AbstractAccepter implements Automaton<State> {
	...
	protected static class AutomatonIterator<State> implements Iterator<String> {
		...
		private String next;
		private final AbstractFA<State> automaton;
		...
		public AutomatonIterator(AbstractFA<State> automaton, CharSet alphabet) {
	...
	protected AbstractFA(CharComparator comparator) {
	...
	public Iterable<String> getDictionary(final CharSet alphabet) {
		return new Iterable<String>() {
			...
			public Iterator<String> iterator() {
				return new AutomatonIterator<State>(AbstractFA.this, alphabet);
			}
	...
	public NFA<State> reverse() {
		...
		reverse.addFinal(getInitialState());
	...
	public void concatenate(Automaton<? extends State> other) {
